...
import hallDiagram from "../Images/Fritzing/Images/NodeHall.png";
...
const AlarmSNHall = props => {
    ...
    return (
        <div>
            ...
            <p>{t("guides.sn-hall-intro")}
            </p>
            <p>
                {t("guides.tooltip-explain0")}
                <ToolDescription id="tooltip-snhall" name={t("tooltip.tooltipname")} description={t("tooltip.tooltipdesc")} />
            ...
            <TabContent activeTab={activeTab}>
                <TabPane tabId="1">
                    <Row>
                        <Col>
                            <img
                                src={hallDiagram}
                                alt="Hall Sensor Node hookup diagram"
                    ...
                    <ul>
                        <li>{t("guides.hall-list0")}</li>
                        <li>{t("guides.hall-list1")}</li>
                        <li>{t("guides.hall-list2")}</li>
                        <li>{t("guides.hall-list3")}</li>
                    </ul>
                ...
                <TabPane tabId="2">
                    ...
                    <h3>{t("guides.parts-list")}</h3>
                    <ul>
                        <li>{t("guides.software.a-hall-sn")}</li>
                        {isTTN()}
                    ...
                    <p>
                        ...
                        <ToolDescription id="ide-snhall" name={t("tooltip.idename")} description={t("tooltip.idedesc")} />
                    ...
                    <p>
                        ...
                        <a href="https://raw.githubusercontent.com/ff-frederiksen/Neighbourhood-Watch/main/Chirpstack/alarm/sensor_nodes/Sensor_node_Contact/Sensor_node_Contact.ino" target="_blank" rel="noopener noreferrer">
                            {t("guides.software.sn-code-hall")}
                        </a>{" "}
                    </p>
                    ...
                    <p>
                        ...
                        <ToolDescription id="lib-snhall" name={t("tooltip.libname")} description={t("tooltip.libdesc")} />
