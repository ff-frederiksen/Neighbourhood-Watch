...
import fugtDiagram from "../Images/Fritzing/Images/NodeFugt.png";
...
const AlarmSNFugt = props => {
    ...
    return (
        <div>
            ...
            <p>{t("guides.sn-fugt-intro")}
            </p>
            <p>
                {t("guides.tooltip-explain0")}
                <ToolDescription id="tooltip-snfugt" name={t("tooltip.tooltipname")} description={t("tooltip.tooltipdesc")} />
            ...
            <TabContent activeTab={activeTab}>
                <TabPane tabId="1">
                    <Row>
                        <Col>
                            <img
                                src={fugtDiagram}
                                alt="Luftfugtighed Sensor Node hookup diagram"
                    ...
                    <ul>
                        <li>{t("guides.fugt-list0")}</li>
                        <li>{t("guides.fugt-list1")}</li>
                        <li>{t("guides.fugt-list2")}</li>
                        <li>{t("guides.fugt-list3")}</li>
                        <li>{t("guides.fugt-list4")}</li>
                        <li>{t("guides.fugt-list5")}</li>
                        <li>{t("guides.fugt-list6")}</li>
                    </ul>
                ...
                <TabPane tabId="2">
                    ...
                    <h3>{t("guides.parts-list")}</h3>
                    <ul>
                        <li>{t("guides.software.a-fugt-sn")}</li>
                        {isTTN()}
                    ...
                    <p>
                        ...
                        <ToolDescription id="ide-snfugt" name={t("tooltip.idename")} description={t("tooltip.idedesc")} />
                    ...
                    <p>
                        ...
                        <a href="https://raw.githubusercontent.com/ff-frederiksen/Neighbourhood-Watch/main/Chirpstack/alarm/sensor_nodes/Sensor_node_Humidity/Sensor_node_Humidity.ino" target="_blank" rel="noopener noreferrer">
                            {t("guides.software.sn-code-fugt")}
                        </a>{" "}
                    </p>
                    ...
                    <p>
                        ...
                        <ToolDescription id="lib-snfugt" name={t("tooltip.libname")} description={t("tooltip.libdesc")} />
                    ...
                    <ul>
                        <li><b>DHT sensor library</b>{" "}{t("guides.software.lib-by")}{" "}<b>Adafruit</b>{" "}{t("guides.software.lib-version")}{" "}<b>1.4.2</b></li>
                    </ul>
